...
namespace Poker {
  namespace HandEval {
    ...
    // Slow hand eval.
    extern HandEvalT eval_hand_7_card(const CardT c0, const CardT c1, const CardT c2, const CardT c3, const CardT c4, const CardT c5, const CardT c6);
    extern HandEvalT eval_hand_holdem(const std::pair<CardT, CardT> hole, const std::tuple<CardT, CardT, CardT> flop, const CardT turn, const CardT river);
